OC.L10N.register(
    "user_retention",
    {
    "Important information regarding your account" : "Dôležité informácie týkajúce sa vášho účtu",
    "Account deletion" : "Zmazanie účtu",
    "You have not used your account since {date}." : "Váš účet ste nepoužili od {date}.",
    "_Due to the configured policy for accounts, inactive accounts will be disabled after %n day._::_Due to the configured policy for accounts, inactive accounts will be disabled after %n days._" : ["Kvôli nastavenej politike pre účty budú neaktívne účty po %n dni deaktivované.","Kvôli nastavenej politike pre účty budú neaktívne účty po %n dňoch deaktivované.","Kvôli nastavenej politike pre účty budú neaktívne účty po %n dňoch deaktivované.","Kvôli nastavenej politike pre účty budú neaktívne účty po %n dňoch deaktivované."],
    "_Due to the configured policy for accounts, inactive accounts will be deleted after %n day._::_Due to the configured policy for accounts, inactive accounts will be deleted after %n days._" : ["Kvôli nastavenej politike pre účty budú neaktívne účty po %n dni vymazané.","Kvôli nastavenej politike pre účty budú neaktívne účty po %n dňoch vymazané.","Kvôli nastavenej politike pre účty budú neaktívne účty po %n dňoch vymazané.","Kvôli nastavenej politike pre účty budú neaktívne účty po %n dňoch vymazané."],
    "To keep your account you only need to login with your browser or connect with a desktop or mobile app. Otherwise your account and all the connected data will be permanently deleted." : "Ak si chcete ponechať svoj účet, stačí sa prihlásiť pomocou prehliadača alebo sa pripojiť k desktopovej alebo mobilnej aplikácii. V opačnom prípade bude váš účet a všetky pripojené údaje natrvalo odstránené.",
    "If you have any questions, please contact your administration." : "Ak máte nejaké otázky, prosím, kontaktujte vašeho administrátora.",
    ...
    "Account deletion:" : "Odstránenie účtu:",
    "Guest account disabling:" : "Deaktivácia účtu návštevníka:",
    "Guest account deletion:" : "Odstránenie účtu hosťa:",
