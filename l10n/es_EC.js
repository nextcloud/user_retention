OC.L10N.register(
    "user_retention",
    {
    "Important information regarding your account" : "Información importante sobre tu cuenta",
    "Account deletion" : "Borrado de cuenta",
    "You have not used your account since {date}." : "No has utilizado tu cuenta desde {date}.",
    ...
    "_Due to the configured policy for accounts, inactive accounts will be deleted after %n day._::_Due to the configured policy for accounts, inactive accounts will be deleted after %n days._" : ["Debido a la política configurada para las cuentas, las cuentas inactivas serán eliminadas después de %n día.","Debido a la política configurada para las cuentas, las cuentas inactivas serán eliminadas después de %n días.","Debido a la política configurada para las cuentas, las cuentas inactivas serán eliminadas después de %n días."],
    "To keep your account you only need to login with your browser or connect with a desktop or mobile app. Otherwise your account and all the connected data will be permanently deleted." : "Para mantener tu cuenta, solo necesitas iniciar sesión con tu navegador o conectarte con una aplicación de escritorio o móvil. De lo contrario, tu cuenta y todos los datos conectados serán eliminados permanentemente.",
    "If you have any questions, please contact your administration." : "Si tienes alguna pregunta, por favor, contacta a tu administración.",
    ...
    "Keep accounts that never logged in" : "Mantener cuentas que nunca hayan iniciado sesión",
    "Account disabling:" : "Deshabilitar cuenta:",
    "days" : "días",
    "(0 to disable)" : "(0 para deshabilitar)",
    "Account expiration:" : "Expiración de cuenta:",
