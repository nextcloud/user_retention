OC.L10N.register(
    ...
    "Users are deleted when they did not log into their account within the given number of days. This will also delete all files of the affected users." : "Os usuarios son eliminados cando non accederon á súa conta dentro do número de días indicado. Isto tamén eliminará todos os ficheiros dos usuarios afectados.",
    "Users from LDAP are deleted locally only, unless the LDAP write support app is enabled. When still available on LDAP, users will reappear." : "Os usuarios de LDAP elimínanse só localmente, a menos que a aplicación de asistencia á escritura LDAP estea activada. Cando aínda estea dispoñíbel en LDAP, os usuarios volverán aparecer.",
