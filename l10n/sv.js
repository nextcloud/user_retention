OC.L10N.register(
    ...
    "Accounts are deleted when they did not log in within the given number of days. This will also delete all files and other data associated with the account.\n\n* 🛂 Different retention possible for normal accounts and accounts of the [guests app](https://apps.nextcloud.com/apps/guests)\n* ⛔ Exclude accounts based on group memberships (default: admin group)\n* 🔑 Exclude accounts that never logged in (default: enabled)" : "Konton tas bort när de inte har loggat in inom det angivna antalet dagar. Då tas även alla filer och andra data som är kopplade till kontot bort.\n\n* 🛂 Olika lagringstid kan anges för vanliga konton och konton från [appen Gäster](https://apps.nextcloud.com/apps/guests)\n* ⛔ Undanta konton utifrån gruppmedlemskap (standard: administratörsgruppen)\n* 🔑 Undanta konton som aldrig har loggat in (aktiverat som standard)",
